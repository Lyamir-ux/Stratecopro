...
| **Dossier → Enquête sociale** | Saisie foyer/occupation/RFR (avis N-1) → profil calculé (barème Anah 2026) ; colonne **Statut** : *Déclaratif* (déclaré par le copropriétaire ou saisi) → case à cocher **Vérifié** après contrôle de l'avis d'imposition (daté ; toute nouvelle déclaration portail repasse en déclaratif) ; **« Configurer »** ouvre le catalogue complet (identité, situation & aides - dont composition du ménage, personnes à charge, RFR avis N-1 / RFR N-2, justification d'un RFR à 0 € -, avis, lots, enquête technique, confort) : interrupteur par question, questions socle verrouillées 🔒, conditions d'affichage, questions personnalisées ; préparation d'envoi |
| **Dossier → Copropriétaires - nouveau** | La vue « qui me manque quoi » : une ligne par copropriétaire avec profil (à déterminer / déclaratif / vérifié), prime individuelle, choix de financement, bulletin, SEPA, RIB, CNI, avis d'imposition et statut du dossier (complet / N manquants / non commencé) ; filtres **Tous / À relancer / Complets**, par bâtiment, recherche ; l'œil ouvre le portail du copropriétaire en aperçu AMO. **Clic sur une ligne = fiche individuelle** : profil de ressources (saisie rapide ménage / occupation / RFR N-1 / RFR N-2 + case Vérifié), plan individuel (quote-part, aides collectives, prime, à financer, reste), financement et adhésion éco-PTZ (bulletins, mandat SEPA, concordance RIB, signature électronique), pièces justificatives (ouverture). **Trois exports .xlsx** en tête : **Liste des primes**, **Rapport d'enquête sociale**, **Fiche état** - générés depuis la même base (mêmes montants au centime), un onglet par bâtiment + synthèse |
...
|---|---|
| **Accueil** | Timeline des phases, **4 tuiles** : quote-part, **aides collectives affectées** (MPR Copro + fonds + CEE au prorata), **aide individuelle** (« À déterminer » tant que l'enquête n'est pas remplie - jamais de montant présumé), à financer avant travaux ; ligne de source sous les tuiles (plan publié le…, **profil déclaratif / vérifié / non renseigné**) ; cartes « À faire » qui reflètent l'avancement réel |
...
| **Enquête sociale** | Questionnaire généré depuis la configuration AMO : carte « Vous » (ménage, RFR…) puis une carte par lot (technique, confort) ; questions conditionnelles en direct (ex. « Date de la chaudière » n'apparaît que si chauffage individuel gaz) ; panneau latéral : progression, badge « Questionnaire complet » quand tout est répondu, **plafonds Anah 2026** puis catégorie du ménage (très modeste → supérieur, sans couleurs) dès que ménage + RFR sont renseignés ; **introduction** (nombre de questions, durée estimée), toutes les questions posées sont obligatoires (*) : **« Transmettre mon questionnaire »** refuse tant qu'il manque une réponse ou l'attestation d'exactitude (liste précise des manques, champs surlignés, défilement vers le premier) ; **« Enregistrer un brouillon »** pour finir plus tard ; RFR à 0 € → justification demandée ; personnes à charge ≥ ménage → erreur (visible ensuite côté AMO, onglet Enquête ou Copropriétaires) |
