...
(() => {
  ...
  const stylesheet =
    ...
    '  background:#fff;box-shadow:0 0 0 1.5px #7AB52C,0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px #7AB52C}' +
    ...
    ':host([data-over]) .frame{outline:2px solid #7AB52C;outline-offset:-2px;' +
    '  background:rgba(122,181,44,.12)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(0,0,0,.25);' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:#7AB52C}' +
