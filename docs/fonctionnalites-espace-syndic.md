...
5. **Documents à produire** (montage bancaire) : parcours par montage - éco-PTZ collectif CEGEE, ANAH - MaPrimeRénov' Copro et dommages-ouvrage ROEDERER - en étapes, chaque étape listant les documents attendus. Dépôt des pièces par clic ou glissé-déposé sur la ligne du document ; les pièces Strat Eco et maîtrise d'œuvre sont affichées pour suivi. Deux formulaires pré-remplis depuis la base projet : fiche de renseignements avant AG et onglet « Demande de prêt » du classeur CEGEE. Le dossier ANAH reprend les 15 pièces de la checklist MaPrimeRénov' en trois volets (copropriété et gouvernance, projet de travaux, volet social et plan de financement) ; les avis d'imposition et la liste des primes individuelles y sont confidentiels : invisibles et non téléchargeables par le syndic, y compris dans l'onglet Fichiers.
