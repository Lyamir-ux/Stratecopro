...
// pppt-verif/1.1 (pourcentages en points, comme le skill), avec des défauts
// volontaires pour exercer les contrôles :
...
export const EXEMPLE: PpptVerifJson = {
  ...
  travaux_normalises: [
    { id: "T01", libelle: "Façade / Ravalement + ITE", priorite: "Énergétique", critere: "Énergie", batiment: null, ouvrage: "Façades", cout_ht_base_eur: 186000, cout_ht_origine: "source", tva_pct: 5.5, regle_tva: "energetique_5_5", avec_moe: false, annee_prevue: 2027, annee_origine: "source", gain_energetique_pct: 25, commentaire: null, controles_lies: [] },
    ...
    { id: "T03", libelle: "Ventilation / VMC hygro B", priorite: "Énergétique", critere: "Santé", batiment: null, ouvrage: "Ventilation", cout_ht_base_eur: null, cout_ht_origine: null, tva_pct: 5.5, regle_tva: "energetique_5_5", avec_moe: false, annee_prevue: 2027, annee_origine: "source", gain_energetique_pct: 4, commentaire: "coût absent du PPPT source", controles_lies: ["R10"] },
    ...
    { id: "T05", libelle: "Chauffage / Chaudière THPE", priorite: "Énergétique", critere: "Énergie", batiment: null, ouvrage: "Chauffage", cout_ht_base_eur: 42000, cout_ht_origine: "source", tva_pct: 5.5, regle_tva: "energetique_5_5", avec_moe: false, annee_prevue: 2029, annee_origine: "source", gain_energetique_pct: 20, commentaire: null, controles_lies: [] },
    { id: "T06", libelle: "Menuiseries / Remplacement", priorite: "Énergétique", critere: "Énergie", batiment: null, ouvrage: "Menuiseries", cout_ht_base_eur: 96000, cout_ht_origine: "source", tva_pct: 5.5, regle_tva: "energetique_5_5", avec_moe: false, annee_prevue: 2030, annee_origine: "source", gain_energetique_pct: 10, commentaire: null, controles_lies: [] },
  ...
  parametres_ppt: { annee_base: 2026, premiere_annee: 2027, horizon: 10, inflation_pct: 3.5, tva_facades_toitures_pct: 10, tva_energetique_pct: 5.5, honoraires_moe_pct: 6, honoraires_syndic_pct: 3, cep_base_kwhep_m2_an: 289 },
  propositions: [
