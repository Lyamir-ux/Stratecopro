...
// pppt-verif/1.0, avec des défauts volontaires pour exercer les contrôles :
...
export const EXEMPLE: PpptVerifJson = {
  ...
  synthese: { verdict: "A_REPRENDRE", nb_bloquants: 1, nb_majeurs: 0, nb_mineurs: 1, score_conformite_pct: 75, score_coherence_pct: 80, points_forts: ["État des lieux détaillé"], questions_ouvertes: ["Année d'adoption prévue en AG ?"] },
  travaux_normalises: [
