                  ...
                  telechargerCsv(
                    ...
                    coproprietaires.map((cp) => {
                      ...
                      return [
                        ...
                        appelsDeFonds?.get(cp.id)?.appel ?? "",
                        appelsDeFonds?.get(cp.id) ? Math.round(appelsDeFonds.get(cp.id)!.primeCee * 100) / 100 : "",
                        ch?.type === "collectif"
                      ...
                      if (enEdition) {
                        return (
                          <tr key={cp.id} style={{ cursor: "default" }}>
                            ...
                            <td>{appelsDeFonds?.get(cp.id) ? fmtEuroFull(appelsDeFonds.get(cp.id)!.appel) : "-"}</td>
                            <td colSpan={2}>
